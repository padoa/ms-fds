...
export class ConcentrationRulesService {
  ...
  private static readonly INFERIOR_REGEX = '(≥|>|>=)';
  private static readonly SUPERIOR_REGEX = '(≤|<|<=)';
  private static readonly DECIMAL_DIGIT_REGEX = `((\\d{1,2}${this.SPACE_REGEX}[\\.,]${this.SPACE_REGEX}\\d+)|(100|\\d{1,2}))`;

  private static readonly RANGE_CONCENTRATION_REGEX = `${this.INFERIOR_REGEX}?${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}${this.SPACE_REGEX}-${this.SPACE_REGEX}${this.SUPERIOR_REGEX}${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}`; // ex: >30-<60
  private static readonly RANGE_PERCENT_CONCENTRATION_REGEX = `${this.INFERIOR_REGEX}?${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}${this.SPACE_REGEX}-${this.SPACE_REGEX}${this.SUPERIOR_REGEX}?${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}%?`; // ex: 50-100%
  private static readonly IN_BETWEEN_RANGE_CONCENTRATION_REGEX = `${this.DECIMAL_DIGIT_REGEX}${this.SPACE_REGEX}${this.SUPERIOR_REGEX}.+${this.SUPERIOR_REGEX}${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}`; // ex: 30 < x% <= 20
  private static readonly PERCENT_CONCENTRATION_REGEX = `(${this.INFERIOR_REGEX}|${this.SUPERIOR_REGEX})${this.SPACE_REGEX}${this.DECIMAL_DIGIT_REGEX}${this.SPACE_REGEX}%?`; // ex: <30%
