...
export class DangersRulesService {
  ...
  public static hazardsRegex = `(${this.customHazards.join(')|(')})|(h[2-4]\\d{2})`;
  public static precautionRegex = '(((p[1-5]\\d{2})\\+?)+)';
  public static europeanHazardsRegex = '(euh[02]\\d{2})|(euh401)';
